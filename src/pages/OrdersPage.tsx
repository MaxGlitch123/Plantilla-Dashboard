...
import {
  Eye, ShoppingBag, Clock, Check, X, Wifi, WifiOff, RefreshCw
} from 'lucide-react';
...
const OrdersPage: React.FC = () => {
  ...
  // No necesitamos esta función ya que usamos validateStockForOrder directamente
  
  // No necesitamos esta función ya que usamos onContinue directamente en el modal

  // La función renderConnectionStatus se ha movido fuera del componente
  
  // El resto del componente continúa aquí...
        ...
        {pedidosFiltrados.length === 0 && !loading && (
          <div className="col-span-full text-center py-8">
            <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-medium text-gray-800 mb-2">No se encontraron pedidos</h3>
              <p className="text-gray-600 mb-4">
                {activeTab === 'all' 
                  ? 'No hay pedidos disponibles en este momento.' 
                  : `No hay pedidos con estado "${statusLabel[activeTab]}" en este momento.`}
              </p>
